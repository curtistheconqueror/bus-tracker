...
| 123 | Live | f154686 | Per-section device transfers merge without replacing unrelated data; ALL DATA and report labels clarify file purpose; backup cadence is settable; phone Service Detail remains visible |
