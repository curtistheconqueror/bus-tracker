...
export const REPAIR_OPTIONS:Record<string,string[]>={
 ...
 "Engine":["Check engine light","Stop engine light","Check engine and stop engine light","Overheating","Misfire","Loss of power","Oil leak","Rear main seal","Coolant level sensor","Water pump belt","Alternator belt","Spark plugs","Valve adjustment","Abnormal noise","Engine replacement","Internal engine repair","Other engine repair"],
