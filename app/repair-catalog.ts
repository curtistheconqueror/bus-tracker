...
export const REPAIR_OPTIONS:Record<string,string[]>={
 ...
 "Operator Controls":["Fuel gauge","Speedometer","Other gauge / indicator","Front instrument dash damaged / replacement","Kneeler switch","Ramp power switch","Ramp deploy / stow switch","Front door open / close switch","Rear door open / close switch","Operator light","A/C control panel","Blower control","Pedal adjuster","Floor heat switch","Interior light controls","Start button","Other operator switch / control","Left-side operator dash damaged / replacement","Driver seat belt","Driver seat leaking air","Driver seat will not lock","Driver seat controls / buttons","Horn / seat alarm will not stop","Other driver seat repair"],
 ...
 "Bodywork":["Accident damage","Body panel","Bumper","Bike rack damaged / not operating","Glass / windshield","Mirror","Paint","Interior body repair","Other bodywork"],
