...
export type QuickFilterKey="ac"|"check-engine"|"bad-ramp"|"no-horn"|"leak"|"add-oil";
export type QuickFilterBus={
 id:string;n?:string;pendingRepair?:string;checkEngine?:boolean;badRampKneeler?:boolean;noHorn?:boolean;defects?:StructuredDefect[];
};
