...
import {CHECK_ENGINE_SYMPTOMS,defaultDefectOperability,defectLabel,isUnresolved,normalizeDefects,REPAIR_OPTIONS,repairCategoryEmoji,repairCategoryLabel,type DefectOperability,type DefectState,type StructuredDefect} from "../repair-catalog";
