...
const CATEGORY_ICONS:Record<string,string>={
 ...
 "Tires and Wheels":"\u25C9","Battery, Starting and Charging":"\u26A1","Electrical / Multiplex":"\u26A1","Bus Controls":"\u25A6","Tech Services":"\u25A4",Amerex:"\u25B3",
...
export default function DefectLog(){
 ...
 return <main className="defect-log-app" style={appStyle} data-font-size={settings.fontSize}>
  ...
  {undoSnapshot&&<section className="log-undo" role="status"><span>{undoSnapshot.label}</span><button type="button" onClick={undoLastChange}>UNDO LAST CHANGE</button><button type="button" className="dismiss-undo" onClick={()=>setUndoSnapshot(null)} aria-label="Dismiss undo">×</button></section>}
