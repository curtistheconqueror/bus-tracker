...
import {defectLabel,isDiagnosticDefect,normalizeRepairHours,normalizeDefects,REPAIR_OPTIONS,repairCategoryLabel,type DefectOperability,type StructuredDefect} from "../repair-catalog";
...
type CompletionDraft={category:string;issue:string;details:string;operability:DefectOperability;actionTaken:string;diagnosticNote:string;repairHours:string;diagnosticHours:string;partNumber:string;partsUsed:boolean;partName:string;rememberScope?:PartMemoryScope;completedBy:string;completedAt:string};
