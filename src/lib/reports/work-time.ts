import {normalizeBusListHours,type BusList,type BusListEntry} from "../fleet/bus-lists.ts";
import {normalizeDefects,normalizeRepairHours} from "../defects/repair-catalog.ts";
